...
class Product(models.Model):
    ...
    product_status = models.ForeignKey(ProductStatus,on_delete=models.CASCADE,null = False)
    product_retail_price= models.DecimalField(max_digits=10, decimal_places=2, null=True , blank=True)
    product_wholesale_price = models.DecimalField(max_digits=10, decimal_places=2, null=True , blank=True)
    product_dealer_price = models.DecimalField(max_digits=10, decimal_places=2, null=True , blank=True)
    product_tax = models.CharField(max_length=50,null = True,blank = True)
    product_category_id = models.ForeignKey(Categories,on_delete=models.CASCADE,null = False)
    ...
    product_qty_hold = models.DecimalField(max_digits=10, decimal_places=2, null=True , blank=True)
...
class ProductAttribute(models.Model):
    ...
    product_id = models.ForeignKey(Product,on_delete=models.CASCADE,null = False)
    prodict_attribute_value_id = models.ForeignKey(AttributeValue,on_delete=models.CASCADE,null = False)
    class Meta:
        app_label = 'product_app'

class OrderProductAttribute(models.Model):
    id = models.AutoField(primary_key=True)
    product_attribute_id = models.ForeignKey(ProductAttribute,on_delete=models.CASCADE,null = False)
